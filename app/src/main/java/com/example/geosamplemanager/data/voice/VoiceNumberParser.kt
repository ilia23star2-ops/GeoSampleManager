 ...
 *
 * FIX 5.8.6-2:
 * Одиночное «ноль» больше не трактуется как счётчик нулей.
 * Счётчик срабатывает только на формы:
 * «два ноля», «три нуля», «четыре ноля», «пять нулей».
 *
 * Это чинит фразу:
 * «пятнадцать двадцать четыре ноль один»
 * которая раньше могла превращаться в 15 20 0000 1
 * и искать пробу 15 20 01.
 */
