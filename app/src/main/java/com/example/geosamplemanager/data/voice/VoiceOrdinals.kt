...
object VoiceOrdinals {
    ...
    /**
     * FIX 5.8.9d-2b: обратный маппинг — «число → слово».
     * Используется в озвучке подтверждений: «Первая отмечена»,
     * «Третья — холостая. Вес?».
     *
     * Возвращает null, если n вне 1..30.
     */
    private val ordinalWords: Map<Int, String> = mapOf(
        1 to "первая", 2 to "вторая", 3 to "третья",
        4 to "четвёртая", 5 to "пятая", 6 to "шестая",
        7 to "седьмая", 8 to "восьмая", 9 to "девятая",
        10 to "десятая",
        11 to "одиннадцатая", 12 to "двенадцатая", 13 to "тринадцатая",
        14 to "четырнадцатая", 15 to "пятнадцатая", 16 to "шестнадцатая",
        17 to "семнадцатая", 18 to "восемнадцатая", 19 to "девятнадцатая",
        20 to "двадцатая",
        21 to "двадцать первая", 22 to "двадцать вторая", 23 to "двадцать третья",
        24 to "двадцать четвёртая", 25 to "двадцать пятая",
        26 to "двадцать шестая", 27 to "двадцать седьмая",
        28 to "двадцать восьмая", 29 to "двадцать девятая",
        30 to "тридцатая"
    )

    fun word(n: Int): String? = ordinalWords[n]
